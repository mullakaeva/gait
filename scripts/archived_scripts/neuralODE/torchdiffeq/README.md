...
## Examples
Examples are placed in the [`examples`](archived_scripts/neuralODE/torchdiffeq/examples) directory.

We encourage those who are interested in using this library to take a look at [`examples/ode_demo.py`](archived_scripts/neuralODE/torchdiffeq/examples/ode_demo.py) for understanding how to use `torchdiffeq` to fit a simple spiral ODE.
