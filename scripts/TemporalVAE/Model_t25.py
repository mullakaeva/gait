...
class TemporalVAE(nn.Module):
    def __init__(self, n_channels=50, L=25, hidden_channels=1024, latent_dims=8):
        """
        ...
        self.encoding_kernels = [3, 5, 5, 7, 9]
        self.encoding_strides = [1, 1, 1, 1, 1]
        self.decoding_kernels = [3, 5, 5, 7, 9]
        self.decoding_strides = [1, 1, 1, 1, 1]
