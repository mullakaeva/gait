...
class LatentODEfunc(nn.Module):
    ...
    def __init__(self, latent_dim=4, nhidden=20):
        ...
        # self.bn_fc1 = nn.BatchNorm1d(nhidden)
...
class RecognitionRNN(nn.Module):
    ...
    def __init__(self, latent_dim=4, obs_dim=2, nhidden=25, nbatch=1):
        ...
        # self.bn = nn.BatchNorm1d(nhidden)
...
class GaitLatentODEModel:
    ...
    def _predict_with_grad(self, batch_xt, times):
        ...
        # odeint take z0's shape = (num_times, n_samples, obs_dim)
        pred_z = odeint(self.func, z0, times).permute(1, 0, 2) # Output = (n_samples, num_times, obs_dim)
